...
export default class Home extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.callAPIServices = this.callAPIServices.bind(this);
        this.state = {
            datasource: cities,
            dataviewed: viewed,
            datafavs: favs
        ...
        try {
            var promiseTest = AsyncStorage.setItem('name', 'bala');
    ...
    componentDidMount() {
        ...
        var data = [
            { _id: 'id1', planet: 'Mars', system: 'mars', inhabited: false, satellites: ['Phobos', 'Deimos'] },
